...
(function($) {
    ...
    confirmOn.defaultSettings = {
        questionText: 'are you sure you want to remove Third Party ?',
    ...
    $.fn.confirmOn = function(options, events, selector, data, handler) {
	 ...
	 $(function() {
                $('#remove-button1').confirmOn({
                    classPrepend: 'myprefix'
                },'click', function(e, confirmed) {
                    if(confirmed) $(this).remove();
                });  
				$('#remove-button2').confirmOn({
                    classPrepend: 'myprefix'
                },'click', function(e, confirmed) {
                    if(confirmed) $(this).remove();
                }); 
				$('#remove-button3').confirmOn({
                    classPrepend: 'myprefix'
                },'click', function(e, confirmed) {
                    if(confirmed) $(this).remove();
                });  
				$('#remove-button4').confirmOn({
                    classPrepend: 'myprefix'
                },'click', function(e, confirmed) {
                    if(confirmed) $(this).remove();
                });  
				$('#remove-button5').confirmOn({
                    classPrepend: 'myprefix'
                },'click', function(e, confirmed) {
                    if(confirmed) $(this).remove();
                });      
